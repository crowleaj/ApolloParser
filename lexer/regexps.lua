...
lor = (lpeg.P"||"/optype("__bit.or", 1))
land = (lpeg.P"&&"/optype("__bit.and", 2))
lbitor = (lpeg.P"|"/optype("__bit.bor", 3))
lbitxor = (lpeg.P"^|"/optype("__bit.bxor", 4))
lbitand = (lpeg.P"&"/optype("__bit.band", 5))
local lbitls = lpeg.P"<<"/optype("__bit.lshift", 6)
local lbitrs = lpeg.P">>"/optype("__bit.rshift", 6)
